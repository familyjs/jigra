...
public class JigraWKCookieObserver: NSObject, WKHTTPCookieStoreObserver {
...
public class JigraCookieManager {
    var config: InstanceConfiguration?

    init(_ jigConfig: InstanceConfiguration?) {
        self.config = jigConfig
    }
