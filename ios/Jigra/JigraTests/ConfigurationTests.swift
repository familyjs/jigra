...
class ConfigurationTests: XCTestCase {
    ...
    func testDefaults() throws {
        ...
        XCTAssertEqual(descriptor.urlScheme, "jigra")
    ...
    func testNavigationRules() throws {
        ...
        let descriptor = InstanceDescriptor.init(at: url, configuration: ConfigurationTests.files[.server], cordovaConfiguration: nil)
        let configuration = InstanceConfiguration(with: descriptor, isDebug: true)
        XCTAssertTrue(configuration.shouldAllowNavigation(to: "navify.web.app"))
        XCTAssertTrue(configuration.shouldAllowNavigation(to: "navify.web.app".uppercased()))
        XCTAssertTrue(configuration.shouldAllowNavigation(to: "test-jigrajs.web.app"))
        XCTAssertTrue(configuration.shouldAllowNavigation(to: "192.168.0.1"))
        XCTAssertTrue(configuration.shouldAllowNavigation(to: "subdomain-test-navifyframework.web.app"))
