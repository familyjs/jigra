...
@available(*, deprecated, message: "'statusBarTappedNotification' has been moved to Notification.Name.jigraStatusBarTapped. 'getLastUrl' and application delegate methods have been moved to ApplicationDelegateProxy.")
// swiftlint:enable line_length
@objc public class JIGBridge: NSObject {
    @objc public static let statusBarTappedNotification = Notification(name: .jigraStatusBarTapped)
