...
/**
 * Represents a single user-data value of any type on the jigra PluginCall object.
 */
public class JSValue {
    ...
    /**
     * @param call The jigra plugin call, used for accessing the value safely.
    ...
    /**
     * Returns the underlying value this object represents, coercing it into a jigra-friendly object if supported.
     */
