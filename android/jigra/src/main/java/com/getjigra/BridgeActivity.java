...
public class BridgeActivity extends AppCompatActivity {
    ...
    /**
     * Initializes the Jigra Bridge with the Activity.
     ...
     *
     * @param plugins A list of plugins to initialize with Jigra
     */
    @Deprecated
     ...
     *
     * @param plugins A list of plugins to initialize with Jigra
     * @param config An instance of a Jigra Configuration to use. If null, will load from file
     */
    @Deprecated
    protected void init(Bundle savedInstanceState, List<Class<? extends Plugin>> plugins, JigConfig config) {
     ...
     *
     * Jigra is backwards compatible such that plugins using legacy permission request codes
     ...
     *
     * Jigra is backwards compatible such that plugins using legacy activity result codes
