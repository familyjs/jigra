...
public class PluginHandle {
    ...
    private JigraPlugin pluginAnnotation;
    ...
    private PluginHandle(Class<? extends Plugin> clazz, Bridge bridge) throws InvalidPluginException {
        ...
        if (pluginAnnotation == null) {
            ...
            if (legacyPluginAnnotation == null) {
                throw new InvalidPluginException("No @JigraPlugin annotation found for plugin " + pluginClass.getName());
            }
    ...
    public JigraPlugin getPluginAnnotation() {
