 ...
 * by the native layer. The "Jigra" interface it extends
 * is the public one.
 */
export interface JigraInstance extends JigraGlobal {
  /**
   * Internal registry for all plugins assigned to the Jigra global.
   * Legacy Jigra referenced this property directly, but as of v3
   * it should be an internal API. Still exporting on the Jigra
...
export interface JigraCustomPlatformInstance {
  name: string;
