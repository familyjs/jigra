...
public class PluginManager {
    ...
    public List<Class<? extends Plugin>> loadPluginClasses() throws PluginLoadException {
        ...
        try {
            ...
            throw new PluginLoadException("Could not parse jigra.plugins.json as JSON");
    ...
    private JSONArray parsePluginsJSON() throws PluginLoadException {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(assetManager.open("jigra.plugins.json")))) {
            ...
            throw new PluginLoadException("Could not load jigra.plugins.json");
        } catch (JSONException e) {
            throw new PluginLoadException("Could not parse jigra.plugins.json as JSON");
        }
    }
