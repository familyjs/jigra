...
export class WebPlugin implements Plugin {
  ...
  protected unimplemented(msg = 'not implemented'): JigraException {
    return new Jigra.Exception(msg, ExceptionCode.Unimplemented);
  }

  protected unavailable(msg = 'not available'): JigraException {
