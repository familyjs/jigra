import { readJSONSync, writeJSONSync } from '@familyjs/utils-fs';
...
class JigLiveReload {
  ...
  async editExtConfigForLiveReload(
    ...
    this.configJsonToRevertTo.platformPath = jigConfigPath;
  ...
  async editJigConfigForLiveReload(
    ...
    writeJSONSync(jigConfigPath, configJson, { spaces: '\t' });
  }
...
export const JigLiveReloadHelper = new JigLiveReload();
