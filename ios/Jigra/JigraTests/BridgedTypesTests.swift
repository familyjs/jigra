...
class BridgedTypesTests: XCTestCase {
    ...
    override class func setUp() {
        ...
        var dictionary: [AnyHashable: Any] = ["testInt": 1 as Int, "testFloat": Float.pi, "testBool": true as Bool,
                                              "testString": "Some string value", "testChild": subDictionary, "testDateString": formatter.string(from: date as Date)]
    ...
    func testNullTransformation() throws {
        ...
        let filteredArray = coercedArray.jigra.replacingNullValues()
        XCTAssertEqual(filteredArray.count, 3)
        XCTAssertNil(filteredArray[1])
        let restoredArray = filteredArray.jigra.replacingOptionalValues()
    ...
    func testSparseArrayCastSuccess() throws {
        ...
        let sparseArray = JSTypes.coerceArrayToJSArray(array)?.jigra.replacingNullValues() as? [String?]
