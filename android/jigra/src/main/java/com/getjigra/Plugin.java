 ...
 * adding the {@link JigraPlugin} annotation to add additional required
...
public class Plugin {
     ...
     * {@link com.getjigra.Bridge#saveCall(PluginCall)},
     * {@link com.getjigra.Bridge#getSavedCall(String)} and
     * {@link com.getjigra.Bridge#releaseCall(PluginCall)}
     */
    @Deprecated
     ...
     * as indexed methods for reflection, and {@link JigraPlugin} annotation data).
     * @param pluginHandle
     */
     ...
     * such as indexed methods for reflection, and {@link JigraPlugin} annotation data).
     * @return
     */
    ...
    public boolean hasDefinedRequiredPermissions() {
        JigraPlugin annotation = handle.getPluginAnnotation();
        if (annotation == null) {
    ...
    public boolean isPermissionDeclared(String alias) {
        ...
        Logger.error(String.format("isPermissionDeclared: No alias defined for %s " + "or missing @JigraPlugin annotation.", alias));
        return false;
    }
     ...
     * the states of permissions defined on the Plugin in conjunction with the @JigraPlugin
    ...
    /**
     * Request all of the specified permissions in the JigraPlugin annotation (if any)
     *
    ...
    /**
     * Gets the Android permission strings defined on the {@link JigraPlugin} annotation with
     ...
     * Request all of the specified permissions in the JigraPlugin annotation (if any)
     *
     * @deprecated use {@link #requestAllPermissions(PluginCall, String)} in conjunction with @JigraPlugin
     */
    @Deprecated
     ...
     * @deprecated use {@link #requestPermissionForAlias(String, PluginCall, String)} in conjunction with @JigraPlugin
     */
    @Deprecated
    ...
    public void requestPermissions(PluginCall call) {
        ...
        if (annotation == null) {
            ...
            // handle permission requests for plugins defined with @JigraPlugin (since 3.0.0)
     ...
     * @deprecated in favor of using callbacks in conjunction with {@link JigraPlugin}
     *
     * @param requestCode
     * @param permissions
     * @param grantResults
