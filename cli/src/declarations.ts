export interface JigraConfig {
  ...
  server?: {
     ...
     * [`cordova-plugin-navify-webview`](https://github.com/navify/cordova-plugin-navify-webview),
     * where the default scheme on iOS is `navify`.
     *
     * @since 1.2.0
     * @default jigra
     */
...
export interface PluginsConfig {
  ...
  /**
   * Jigra Portals plugin configuration
   *
   * @since 3.5.0
   */
  Portals?: {
