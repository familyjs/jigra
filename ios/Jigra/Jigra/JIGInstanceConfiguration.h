#ifndef JIGInstanceConfiguration_h
#define JIGInstanceConfiguration_h

@import UIKit;

@class JIGInstanceDescriptor;

NS_SWIFT_NAME(InstanceConfiguration)
@interface JIGInstanceConfiguration: NSObject
...
- (instancetype _Nonnull)initWithDescriptor:(JIGInstanceDescriptor* _Nonnull)descriptor isDebug:(BOOL)debug NS_SWIFT_NAME(init(with:isDebug:));
- (instancetype _Nonnull)updatingAppLocation:(NSURL* _Nonnull)location NS_SWIFT_NAME(updatingAppLocation(_:));
@end

#endif /* JIGInstanceConfiguration_h */
