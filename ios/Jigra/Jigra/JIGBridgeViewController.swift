...
@objc open class JIGBridgeViewController: UIViewController {
    private var jigraBridge: JigraBridge?
    ...
    override public final func loadView() {
        ...
        let configuration = InstanceConfiguration(with: configDescriptor, isDebug: JigraBridge.isDevEnvironment)
    ...
    /**
     The InstanceDescriptor that should be used for the Jigra environment.
    ...
    /**
     ...
     - Parameter instanceConfiguration: the configuration that will define the jigra environment.
    ...
    public final func loadWebView() {
        guard let bridge = jigraBridge else {
            return
        }
...
extension JIGBridgeViewController {
...
extension JIGBridgeViewController {
    private func prepareWebView(with configuration: InstanceConfiguration, assetHandler: WebViewAssetHandler, delegationHandler: WebViewDelegationHandler) {
        ...
        aWebView.jigra.setKeyboardShouldRequireUserInteraction(false)
        // set our ivar
        webView = aWebView
        // set our delegates
