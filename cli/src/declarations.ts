export interface JigraConfig {
  ...
  /**
   * Whether to copy the Jigra runtime bundle or not.
   *
   * If your app is not using a bundler, set this to `true`, then Jigra
   * will create a `jigra.js` file that you'll need to add as a script in
   * your `index.html` file.
   *
   * It's deprecated and will be removed in Jigra 6
   *
   * @since 1.0.0
   * @deprecated 5.0.0
   * @default false
  ...
  /**
   * The build configuration (as defined by the native app) under which Jigra
  ...
  /**
   * String to append to the original user agent of Jigra Web View.
   *
  ...
  /**
   * Background color of the Jigra Web View.
   *
   * @since 1.1.0
   */
  ...
  android?: {
    ...
    /**
     * User agent of Jigra Web View on Android.
     *
    ...
    /**
     * String to append to the original user agent of Jigra Web View for Android.
     *
    ...
    /**
     * Background color of the Jigra Web View for Android.
     *
    ...
    /**
     * The build configuration under which Jigra will generate logs on Android.
     *
    ...
    /**
     * Allowlist of plugins to include during `npx jig sync` for Android.
     *
     ...
     * configure the flavor you want to run with `npx jig run` command.
     *
     * @since 3.1.0
     */
    flavor?: string;
     ...
     *
     * The minimum supported cannot be lower than version `10`, which is required for Jigra.
     *
     * If the device uses a lower WebView version, an error message will be shown on Logcat.
     * If `server.errorPath` is configured, the WebView will redirect to that file, so can be
     * used to show a custom error.
  ...
  ios?: {
    ...
    /**
     * User agent of Jigra Web View on iOS.
     *
     * Overrides global `overrideUserAgent` option.
     *
     * @since 1.4.0
    ...
    /**
     * String to append to the original user agent of Jigra Web View for iOS.
     *
     * Overrides global `appendUserAgent` option.
     *
     * This is disregarded if `overrideUserAgent` is used.
    ...
    /**
     * Background color of the Jigra Web View for iOS.
     *
     * Overrides global `backgroundColor` option.
     *
     * @since 1.1.0
    ...
    /**
     * The build configuration under which Jigra will generate logs on iOS.
     *
     * Overrides global `loggingBehavior` option.
     *
     * @since 3.0.0
    ...
    /**
     * Allowlist of plugins to include during `npx jig sync` for iOS.
     *
     * Overrides global `includePlugins` option.
     *
     * @since 3.0.0
    ...
    /**
     * Configure if Jigra will handle local/push notifications.
  ...
  server?: {
     ...
     * [`cordova-plugin-family-webview`](https://github.com/familyjs/cordova-plugin-family-webview),
     * where the default scheme on iOS is `family`.
     *
     * @since 1.2.0
     * @default jigra
     */
     ...
     * On Android the html file won't have access to Jigra plugins.
     *
     * @since 4.0.0
     * @default null
     */
  ...
  cordova?: {
     ...
     *
     * It's deprecated and will be removed in Jigra 7
     *
     * @since 3.3.0
     * @deprecated 6.1.1
     */
  ...
  /**
   * Allowlist of plugins to include during `npx jig sync`.
   *
   * This should be an array of strings representing the npm package name of
   * plugins to include when running `npx jig sync`. If unset, Jigra will
...
export interface PluginsConfig {
  ...
  JigraCookies?: {
    /**
     * Enable JigraCookies to override the global `document.cookie` on native.
     *
     * @default false
     */
    enabled?: boolean;
  ...
  /**
   * Jigra Http plugin configuration
   *
   * @since 4.3.0
   */
  JigraHttp?: {
    /**
     * Enable JigraHttp to override the global `fetch` and `XMLHttpRequest` on native.
     *
     * @default false
     */
    enabled?: boolean;
