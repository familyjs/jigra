...
public class JigraCookieManager extends CookieManager {
    ...
    private final String TAG = "JigraCookies";

    /**
     * Create a new cookie manager with the default cookie store and policy
     */
    public JigraCookieManager(Bridge bridge) {
     ...
     */
    public JigraCookieManager(CookieStore store, CookiePolicy policy, Bridge bridge) {
        super(store, policy);
        ...
        for (String headerKey : responseHeaders.keySet()) {
            ...
            for (String headerValue : Objects.requireNonNull(responseHeaders.get(headerKey))) {
                try {
                    ...
                    // Set at the defined domain in the response or at default jigra hosted url
