...
extension WKWebView: JigraExtension {}
public extension JigraExtensionTypeWrapper where T == WKWebView {
    ...
    static let oneTimeOnlySwizzle: () = {
        ...
        let swizzleFourArgClosure = { (method: Method, selector: Selector) in
            ...
            let block : @convention(block) (Any, UnsafeRawPointer, Bool, Bool, Any?) -> Void = { (me, arg0, arg1, arg2, arg3) in
                if let webview = containingWebView(me), let flag = webview.jigra.keyboardShouldRequireUserInteraction {
