...
/**
 * Represents the configuration options for plugins used by Jigra
 */
public class PluginConfig {
    ...
    /**
     * Get a string value for a plugin in the Jigra config.
     *
    ...
    /**
     * Get a boolean value for a plugin in the Jigra config.
     *
     * @param configKey The key of the value to retrieve
     * @param defaultValue A default value to return if the key does not exist in the config
     * @return The value from the config, if key exists. Default value returned if not
    ...
    /**
     * Get an integer value for a plugin in the Jigra config.
     *
     * @param configKey The key of the value to retrieve
     * @param defaultValue A default value to return if the key does not exist in the config
     * @return The value from the config, if key exists. Default value returned if not
    ...
    /**
     * Get a string array value for a plugin in the Jigra config.
     *
     * @param configKey The key of the value to retrieve
     * @return The value from the config, if exists. Null if not
     */
    ...
    /**
     * Get a JSON object value for a plugin in the Jigra config.
     *
     * @param configKey The key of the value to retrieve
     * @return The value from the config, if exists. Null if not
     */
