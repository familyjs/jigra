...
export const APP_ID = 'com.getjigra.cli.test';
export const APP_NAME = 'Jigra CLI Test';
...
<head>
  <meta charset="UTF-8">
  <title>Test Jigra App</title>
</head>
<body>
  <jigra-welcome></jigra-welcome>
</body>
</html>
`;
...
`;
  ...
  // We use 'npm install' to install @jigra/core and @jigra/cli
  // Otherwise later use of 'npm install --save @jigra/android|ios' will wipe 'node_modules/@jigra/'
    ...
    <platform name="android">
        <config-file target="res/xml/config.xml" parent="/*">
            <feature name="CoolPlugin">
                <param name="android-package" value="com.getjigra.cordova.CoolPlugin"/>
            </feature>
        </config-file>
        <source-file src="android/com/getjigra/CoolPlugin.java" target-dir="src/com/getjigra/cordova" />
    </platform>
    <platform name="ios">
...
async function makeCordovaPlugin(cordovaPluginPath: string) {
  ...
  const androidPath = join(cordovaPluginPath, 'android/com/getjigra');
