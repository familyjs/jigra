...
import type { JigraException } from './util';

export interface JigraGlobal {
  /**
   * The Exception class used when generating plugin Exceptions
   * from bridge calls.
   */
  Exception: typeof JigraException;
   ...
   * v3 and Jigra.Plugins property definition will not be exported in v4.
   */
...
/**
 * Register plugin implementations with Jigra.
 *
 ...
 *
 * Each key should be the lowercased platform name as recognized by Jigra,
