...
public class JigraHttpUrlConnection implements IJigraHttpUrlConnection {

    private final HttpURLConnection connection;

    /**
     * Make a new JigraHttpUrlConnection instance, which wraps around HttpUrlConnection
     ...
     */
    public JigraHttpUrlConnection(HttpURLConnection conn) {
        connection = conn;
    ...
    public void setSSLSocketFactory(Bridge bridge) {
        ...
        try {
            Class<?> sslPinningImpl = Class.forName("app.family.sslpinning.SSLPinning");
